...
public class StringUtil {
     ...
     */
    public static String defaultIfNull(Object str) {
        return (str == null) ? EMPTY_STRING : str.toString();
    }
     ...
     */
     public static boolean isInteger(Object o) {
         if(o==null || (o.toString().length() == 0))return false;
     ...
     * @param o Object
     *
     * @return 如果不是Integer，则返回Integer.MIN_VALUE
     */
    public static Integer getInteger(Object o) {
        if(!isInteger(o))return Integer.MIN_VALUE;
     ...
     * @param o Object
     *
     * @return 如果不是Double，则返回Double.MIN_VALUE
     */
    public static Double getDouble(Object o) {
        if(!isDouble(o))return Double.MIN_VALUE;
